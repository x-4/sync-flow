...
const buffers = require('./frame-buffer');
const Limiter = require('./concurrency-limiter');
const { kStatusCode } = require('./protocol-constants');
...
class PayloadCompressor {
  /**
   * Creates a PayloadCompressor instance.
   *
